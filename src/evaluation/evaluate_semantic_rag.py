...
from src.rag.semantic_rag_app import semantic_rag_app
...
def run_evaluation(questions, documents, metrics=RAGAS_METRICS) -> pd.DataFrame:
    ...
    # Build app + retriever ONCE
    app, retriever = semantic_rag_app(documents)
    ...
    for q in questions:
        ...
        examples.append({
            ...
            "ground_truth": "",  # no ground_truth available
